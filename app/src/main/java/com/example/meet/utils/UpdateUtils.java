...
import com.example.meet.bmob.UpdateSet;
...
public class UpdateUtils {
    ...
    private void createUpdateDialog(final UpdateSet updateSet) {
        mUpdateView = DialogManager.getInstance().initDialogView(mContext, R.layout.dialog_update_app);
        ...
        tv_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogManager.getInstance().hideDialog(mUpdateView);
        ...
        DialogManager.getInstance().showDialog(mUpdateView);
